            ...
            {Array.from({ length: ROB_SIZE }, (_, i) => {
              return (
                <tr key={i} className="blue">
                  <td className={rob_entry_color(i)}>{head_tail_comp(i)}</td>
                  <td className={rob_entry_color(i)}>{i}</td>
                  <td className={rob_entry_color(i)}>{destination_tags[i]}</td>
                  <td className={rob_entry_color(i)}>{tag_olds[i]}</td>
                </tr>
              );
            })}
          </tbody>
