...
const BranchGshare: React.FC<{
    ...
    let resolved_comp = null; // don't show it if not
    if (is_resolved) {
        ...
        // Resolved PHT:
        resolved_comp = (
            <div className="inner-section branch-section w-[100%] mt-1">
                <div className="flex">
                    Predicted Result:{" "}
                    <span className={`${predict_color} ml-auto`}>
                        {predicted}
                    </span>
                </div>
                <div className="flex">
    ...
    const subsection_comp = (
        ...
        <div className="branch-section sub-section font-bold">
            ...
            <div className="flex">
                Branch Status:{" "}
                <span className={`font-bold ${branch_color} ml-4`}>
                    {branch_text}
                </span>
            </div>
