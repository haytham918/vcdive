  ...
  return (
    ...
    >
      <MenuButton className="w-[30px]flex items-center justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-babyblue text-white hover:bg-babyblue-hover focus:outline-none">
        ...
        <MenuItems
          anchor="bottom"
          className="absolute right-0 w-40 rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 z-10"
        >
            ...
            <MenuItem key={item.sys}>
              {({ focus }) => (
                <button
                  ...
                  className={`flex font-bold w-full items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 ${
